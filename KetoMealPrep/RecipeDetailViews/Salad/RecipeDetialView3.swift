...
struct RecipeDetailView3: View {
    
    
    
    let KetoJSONDecodedDetail: [RecipeArray] = Bundle.main.decode("KetoRecipeDetail.json")
    let KetoJSONDecodedHealth: RecipeHealth? = Bundle.main.decode("RecipeHealth3.json")
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 0) {
                ...
                ZStack(alignment: .bottomLeading) {
                    ...
                    HStack(spacing: 75) {
                        Text("\(KetoJSONDecodedDetail[3].title ?? "")")
                            .foregroundColor(.white)
                            .bold()
                            .frame(width: 210, height: 100)
                        
                        
                        Text("Health Score: \(KetoJSONDecodedDetail[3].healthScore ?? 0)")
                ...
                ZStack(alignment: .leading) {
                    ...
                    VStack(alignment: .leading, spacing: 0) {
                        ...
                        VStack(alignment: .leading, spacing: 5) {
                            ...
                            Text("\(KetoJSONDecodedDetail[3].extendedIngredients[0].original ?? "")")
                                .font(.system(size: 15, weight: .semibold))
                            
                            
                            
                            
                            Text("\(KetoJSONDecodedDetail[3].extendedIngredients[1].original ?? "")")
                                .font(.system(size: 15, weight: .semibold))
                            
                            
                            
                            Text("\(KetoJSONDecodedDetail[3].extendedIngredients[2].original ?? "")")
                                .font(.system(size: 15, weight: .semibold))
                            
                            
                            
                            Text("\(KetoJSONDecodedDetail[3].extendedIngredients[3].original ?? "")")
                                .font(.system(size: 15, weight: .semibold))
                  
                  
                            
                            Text("\(KetoJSONDecodedDetail[3].extendedIngredients[4].original ?? "")")
                                .font(.system(size: 15, weight: .semibold))
                            
                            
                            Text("\(KetoJSONDecodedDetail[3].extendedIngredients[5].original ?? "")")
                                .font(.system(size: 15, weight: .semibold))
                            
                            
                            
                            Text("\(KetoJSONDecodedDetail[3].extendedIngredients[6].original ?? "")")
                                .font(.system(size: 15, weight: .semibold))
                            
                            
                            Text("\(KetoJSONDecodedDetail[3].extendedIngredients[7].original ?? "")")
                                .font(.system(size: 15, weight: .semibold))
                            
                            Text("\(KetoJSONDecodedDetail[3].extendedIngredients[8].original ?? "")")
                                .font(.system(size: 15, weight: .semibold))
                        ...
                        VStack(alignment: .leading, spacing: 10) {
                            ...
                            HStack {
                                VStack(alignment: .leading, spacing: 10) {
                                    ...
                                    Text("1. \(KetoJSONDecodedDetail[3].analyzedInstructions[0].steps[2].equipment[0].name ?? "")")
                                        .font(.system(size: 20, weight: .semibold))
                                    
                                    
                                    Text("2. \(KetoJSONDecodedDetail[3].analyzedInstructions[0].steps[3].equipment[0].name ?? "")")
                                        .font(.system(size: 20, weight: .semibold))
                    ...
                    VStack(alignment: .leading, spacing: 20) {
                        ...
                        HStack {
                            Text("Total Time:")
                                .font(.system(size: 20, weight: .semibold))
                                .padding(.horizontal)
                            Text("\(KetoJSONDecodedDetail[3].readyInMinutes?.formatNumber() ?? "") mins")
                                .font(.system(size: 20, weight: .semibold))
                        }
                ...
                ZStack(alignment: .topLeading) {
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        VStack(alignment: .leading) {
                            ...
                            Text("1. \(KetoJSONDecodedDetail[3].analyzedInstructions[0].steps[0].step ?? "")")
                                .font(.system(size: 18, weight: .semibold))
                                .padding(.bottom)
                            
                            
                            Text("2. \(KetoJSONDecodedDetail[3].analyzedInstructions[0].steps[1].step ?? "")")
                                .font(.system(size: 18, weight: .semibold))
                                .padding(.bottom)
                            
                            Text("3. \(KetoJSONDecodedDetail[3].analyzedInstructions[0].steps[2].step ?? "")")
                                .font(.system(size: 18, weight: .semibold))
                                .padding(.bottom)
                            
                            Text("4. \(KetoJSONDecodedDetail[3].analyzedInstructions[0].steps[3].step ?? "")")
                                .font(.system(size: 18, weight: .semibold))
                                .padding(.bottom)
                            
                            Text("5. \(KetoJSONDecodedDetail[3].analyzedInstructions[0].steps[4].step ?? "")")
                                .font(.system(size: 18, weight: .semibold))
                                .padding(.bottom)
                ...
                Link(destination: URL(string: "\(KetoJSONDecodedDetail[3].sourceUrl)")!, label: {
...
struct RecipeDetailView3_Previews: PreviewProvider {
