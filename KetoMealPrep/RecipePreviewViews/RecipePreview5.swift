...
struct RecipePreview5: View {
    ...
    var body: some View {
       ...
       Spacer()
            NavigationLink(
            destination: RecipeDetailView29(),
            label: {
       ...
       Spacer()
            NavigationLink(
            destination: RecipeDetailView34(),
            label: {
...
struct RecipePreview5_Previews: PreviewProvider {
